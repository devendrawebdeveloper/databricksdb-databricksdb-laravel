...
use DataBricks\Laravel\Schema\Blueprint as DataBricksBlueprint;
use DataBricks\Laravel\Schema\Grammar\CompilesKeys;
use DataBricks\Laravel\Schema\Grammar\ModifiesColumns;
...
class Grammar extends MySqlGrammar
{
    ...
    {
        // Before anything kicks off, we need to add the DataBricks modifiers
        // so that they'll get used while the columns are all compiling.
        $this->addDataBricksModifiers();
    }
    ...
    {
        // For DataBricks, `point` is invalid. It uses `geographypoint` instead.
    ...
    protected function getType(Fluent $column)
    {
        ...
        if (! is_null($column->storedAs)) {
            ...
            // but for DataBricks it's `<name> as (<expression>) persisted <datatype>`. Here
    ...
    protected function getColumns(Blueprint $blueprint)
    {
        ...
        if ($blueprint->creating()) {
            ...
            $columns[] = DataBricksBlueprint::INDEX_PLACEHOLDER;
        }
