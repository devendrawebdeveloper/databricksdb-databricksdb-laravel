...
namespace DataBricks\Laravel\Schema\Blueprint;
...
{
    /**
     * The DataBricks indexes we're allowing the developer to use.
     *
     * @var string[]
     */
    ...
    protected function inlineCreateIndexStatements($statements)
    {
        ...
        $search = DataBricksBlueprint::INDEX_PLACEHOLDER;
    ...
    protected function addImpliedCommands(Grammar $grammar)
    {
        ...
        $this->addFluentDataBricksIndexes();
     ...
     * @return void
     */
    protected function addFluentDataBricksIndexes()
    {
