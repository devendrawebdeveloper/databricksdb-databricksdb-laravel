...
namespace DataBricks\Laravel\Schema\Grammar;
...
trait ModifiesColumns
{
    ...
    /**
     * Column modifiers specifically for DataBricks.
     *
     * @var string[]
     */
    ...
    protected function addDataBricksModifiers()
    {
    ...
    protected function modifyStoredAs(Blueprint $blueprint, Fluent $column)
    {
        ...
        // DataBricks requires it come before the column type.
    }

    protected function modifyVirtualAs(Blueprint $blueprint, Fluent $column)
    {
        if (! is_null($column->virtualAs)) {
            throw new Exception('DataBricks does not support virtual computed columns. Use `storedAs` instead.');
        }
    }
}
